        ...
        <div className="card-body relative z-10">
          <div className={cn("flex", layoutClasses)}>
            <div className={cn(qrContainerClasses)}>
              <button
                onClick={() =>
                  window.open(channelUrl || qrCodeContent, "_blank", "noopener,noreferrer")
                }
                className={cn(
                ...
                <div className={cn("flex gap-4 text-sm", isVertical ? "justify-center" : "")}>
                  {subscribers && (
                    <div>
                      ...
                      <span className="opacity-70 ml-1">Subscribers</span>
                    </div>
                  )}
                  {videos && (
                    <div>
                      <span className="font-medium">{videos}</span>
                      <span className="opacity-70 ml-1">Videos</span>
                    </div>
                  )}
                </div>

                <div className="text-sm opacity-70 font-semibold">
                  Scan QR code to subscribe on YouTube
                </div>
              </div>
            </div>
          </div>
