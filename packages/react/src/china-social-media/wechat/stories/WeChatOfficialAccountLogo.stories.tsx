...
import { WeChatLogo } from "../logo/wechat-official-account";

const meta: Meta<typeof WeChatLogo> = {
  title: "China/Wechat/Logo/WeChatOfficialAccountLogo",
    ...
    <div className="flex flex-col gap-8 items-center">
      <div className="text-center">
        ...
        <div className="flex items-center gap-6">
          <div className="text-center">
            <WeChatLogo variant="full-color" language="zh" size={100} />
            <p className="mt-2 text-sm text-gray-600">Full Color</p>
          </div>
          <div className="text-center">
            <WeChatLogo variant="inverted" language="zh" size={100} />
            <p className="mt-2 text-sm text-gray-600">Inverted</p>
          </div>
        </div>
        <div className="bg-gray-800 p-6 rounded-lg mt-4">
          <div className="text-center">
            <WeChatLogo variant="white" language="zh" size={100} />
