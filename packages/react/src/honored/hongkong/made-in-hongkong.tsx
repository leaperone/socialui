...
export interface MadeInHongKongProps {
  prefix?: string;
  suffix?: string;
  className?: string;
...
export const MadeInHongKong = forwardRef<HTMLDivElement, MadeInHongKongProps>((props, ref) => {
  const {
    prefix = "Made in",
    suffix = "Hong Kong",
...
MadeInHongKong.displayName = "MadeInHongKong";
