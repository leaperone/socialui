...
import { MadeInHongKong } from "./made-in-hongkong";

const meta: Meta<typeof MadeInHongKong> = {
  title: "Honored/MadeInHongKong",
  component: MadeInHongKong,
  parameters: {
    layout: "centered",
  },
  tags: ["autodocs"],
  argTypes: {
    prefix: {
      control: "text",
      description: "Text before the Hong Kong flag",
    },
    suffix: {
      control: "text",
      description: "Text after the Hong Kong flag",
    },
    className: {
      control: "text",
