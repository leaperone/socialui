...
export interface MadeInJapanProps {
  prefix?: string;
  suffix?: string;
  className?: string;
...
export const MadeInJapan = forwardRef<HTMLDivElement, MadeInJapanProps>((props, ref) => {
  const {
    prefix = "Made in",
    suffix = "Japan",
...
MadeInJapan.displayName = "MadeInJapan";
