...
export interface MadeInChinaProps {
  prefix?: string;
  suffix?: string;
  className?: string;
...
export const MadeInChina = forwardRef<HTMLDivElement, MadeInChinaProps>((props, ref) => {
  const {
    prefix = "Made in",
    suffix = "China",
...
MadeInChina.displayName = "MadeInChina";
