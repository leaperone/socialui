...
export interface MadeInUSAProps {
  prefix?: string;
  suffix?: string;
  className?: string;
...
export const MadeInUSA = forwardRef<HTMLDivElement, MadeInUSAProps>((props, ref) => {
  const {
    prefix = "Made in",
    suffix = "USA",
...
MadeInUSA.displayName = "MadeInUSA";
