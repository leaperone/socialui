...
import { MadeInMacau } from "./made-in-macau";

const meta: Meta<typeof MadeInMacau> = {
  title: "Honored/MadeInMacau",
  component: MadeInMacau,
  parameters: {
    layout: "centered",
  },
  tags: ["autodocs"],
  argTypes: {
    prefix: {
      control: "text",
      description: "Text before the Macau flag",
    },
    suffix: {
      control: "text",
      description: "Text after the Macau flag",
    },
    className: {
      control: "text",
