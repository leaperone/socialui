...
import { MadeInKorea } from "./made-in-korea";

const meta: Meta<typeof MadeInKorea> = {
  title: "Honored/MadeInKorea",
  component: MadeInKorea,
  parameters: {
    layout: "centered",
  },
  tags: ["autodocs"],
  argTypes: {
    prefix: {
      control: "text",
      description: "Text before the Korea flag",
    },
    suffix: {
      control: "text",
      description: "Text after the Korea flag",
    },
    className: {
      control: "text",
